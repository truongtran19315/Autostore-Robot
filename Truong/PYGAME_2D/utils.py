...
class Utils:
    ...
    def getDistanceFromObstacle(obstacle, xSource, ySource, xTarget, yTarget):
        ...
        if obstacle.shape == "circle":
            ...
            a1, b1, c1 = Utils.findLinePassTwoPoints(
                topLeft[0], topLeft[1], botLeft[0], botLeft[1])
            a2, b2, c2 = Utils.findLinePassTwoPoints(
                # a = 0, b = y
                botLeft[0], botLeft[1], botRight[0], botRight[1])
            # x3Point = topRight[0]
            a3, b3, c3 = Utils.findLinePassTwoPoints(
                topRight[0], topRight[1], botRight[0], botRight[1])
