...
class PLAYER_SETTING:
    ...
    ALPHAGOAL_MIN = 0
    ALPHAGOAL_MAX = PI
    MIN_LIDAR_THRESHOLD_FOWARD = 20
    MIN_LIDAR_THRESHOLD_SIDE = 25
    MIN_LIDAR_THRESHOLD = 15
...
class OBSTACLE_SETTING:
    ...
    MAX_HEIGHT = 100
    MIN_HEIGHT = PLAYER_SETTING.RADIUS_OBJECT*2
    MAX_WIDTH = 100
    MIN_WIDTH = PLAYER_SETTING.RADIUS_OBJECT*2
